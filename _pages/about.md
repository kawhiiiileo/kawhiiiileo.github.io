...
🎆 🎓 I recently graduated with my bachelor's degree and am currently working as a research assistant at the **EPIC Lab, Shanghai Jiao Tong University**, supervised by Prof. [Linfeng Zhang](https://scholar.google.com/citations?user=6tWunTgAAAAJ&hl=zh-CN). I am also fortunate to collaborate with Dr. [Siteng Huang](https://kyonhuang.top/) from **DAMO Academy**, and Master’s student [Xuyang Liu](https://xuyang-liu16.github.io/) from **Sichuan University (SCU)**.
